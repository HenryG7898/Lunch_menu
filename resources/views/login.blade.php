...
@section('content')
    <div class=" h-screen flex justify-center items-center bg-black">
        <form action="{{url('login')}}" method="post" class="p-10 bg-white rounded flex justify-center items-center flex-col shadow-md">
          @csrf
            ...
            <button  class="bg-purple-600 hover:bg-purple-900 text-white font-bold p-2 rounded w-80" type="submit"><span>Login</span></button>
        </form>
    </div>
